                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between',padding:10,backgroundColor:'#eee',margin:5 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'flex-start' }}>
                        ...
                        <View>
                         ...
                         <Text style={{marginLeft:10,color:'gray'}}>case Number: {item.item.names}</Text>                       
                        </View>
                       
                    </View>
                    <TouchableOpacity style={[styles.btn,{backgroundColor: "#42a5f5",}]} onPress={() => {navigation.navigate('CheckIn', { item})}} >
